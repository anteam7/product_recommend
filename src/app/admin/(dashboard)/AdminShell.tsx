    ...
    items: [
      {
        ...
        icon: '🅒',
        match: (p) =>
          p.startsWith('/admin/coupang-publish') && !p.startsWith('/admin/coupang-publish/traction'),
      },
      {
        href: '/admin/coupang-publish/traction',
        label: 'Traction 보드 (D+30)',
        icon: '📈',
        match: (p) => p.startsWith('/admin/coupang-publish/traction'),
      },
      {

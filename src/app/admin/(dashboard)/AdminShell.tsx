    ...
    items: [
      {
        ...
        match: (p) =>
          ...
          p === '/admin/coupang-publish/' ||
          (p.startsWith('/admin/coupang-publish') && !p.startsWith('/admin/coupang-publish/rank-watch')),
      },
      {
        href: '/admin/coupang-publish/rank-watch',
        label: 'SERP 순위 추적',
        icon: '📈',
        match: (p) => p.startsWith('/admin/coupang-publish/rank-watch'),
      },
      {
